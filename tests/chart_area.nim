#
# Example of creating Excel area charts using the nimlibxlsxwriter 
# library
#
...
proc main() =
  ...
  #
  var chart: ptr lxw_chart = workbook_add_chart(workbook, LXW_CHART_AREA.uint8)
  ...
  chart_series_set_name_range(series, "Sheet1", 0, 2)
  ...
  discard worksheet_insert_chart(worksheet, 1, 4, chart)

  #
  # Chart 2. Create a stacked area chart.
  #
  chart = workbook_add_chart(workbook, LXW_CHART_AREA_STACKED.uint8)
  ...
  # Insert the chart into the worksheet
  discard worksheet_insert_chart(worksheet, 17, 4, chart)

  #
  # Chart 3. Create a percent stacked area chart.
  #
  chart = workbook_add_chart(workbook, LXW_CHART_AREA_STACKED_PERCENT.uint8)
  ...
  # Add a chart title and some axis labels.
  chart_title_set_name(chart, "Result of sample analysis")
  chart_axis_set_name(chart.x_axis, "Test number")
  chart_axis_set_name(chart.y_axis, "Sample length (mm)")
  ...
  # Insert the chart into the worksheet
  discard worksheet_insert_chart(worksheet, 33, 4, chart)
