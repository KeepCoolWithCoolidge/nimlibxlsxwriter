#
# Example of creating Excel bar charts using the nimlibxlsxwriter 
# library
#
...
proc main() =
  var workbook: ptr lxw_workbook = new_workbook("chart_bar.xlsx")
  ...
  #
  var chart: ptr lxw_chart = workbook_add_chart(workbook, LXW_CHART_BAR.uint8)
  ...
  #
  chart = workbook_add_chart(workbook, LXW_CHART_BAR_STACKED.uint8)
  ...
  #
  chart = workbook_add_chart(workbook, LXW_CHART_BAR_STACKED_PERCENT.uint8)
