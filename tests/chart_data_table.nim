#
# Example of creating Excel column charts with data tables using the 
# nimlibxlsxwriter library
#
# Adapted from chart_data_table.c by John McNamara, Copyright 2014-2018
#
#
...
proc main() =
  var workbook: ptr lxw_workbook = workbook_new("chart_data_table.xlsx")
  ...
  chart_set_table_grid(chart, LXW_TRUE.uint8, LXW_TRUE.uint8, LXW_TRUE.uint8, LXW_TRUE.uint8)
